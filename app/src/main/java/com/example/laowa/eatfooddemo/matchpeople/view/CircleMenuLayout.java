...
CircleMenuLayout extends ViewGroup {
    ...
    private String[] mItemTexts = new String[]{"川师罗志祥", "趣多多", "海贼王的男人",
            "川师第一小鱼人", "永远的哥哥", "雪糕 ","格瓦斯"};
    private int[] mItemImgs = new int[]{R.mipmap.lzx,
            R.mipmap.manone, R.mipmap.lzxone,
            R.mipmap.zgr, R.mipmap.hzw,R.mipmap.icon_head10,
            R.mipmap.icon_head6
            };
    ...
    public CircleMenuLayout(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < mItemImgs.length; i++) {
            final int j = i;
            View view = mInflater.inflate(R.layout.match_people, this,
                    false);//动态加载布局文件...并封装...
            ...
            view.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //         Intent intent = new Intent(this, MainActivity.cla)
                    intent.putExtra("name",mItemTexts[j]);
                    System.out.println("mItemTexts====================" + mItemTexts[j]);
                    intent.putExtra("imageLeft",mItemImgs[j]);
                    System.out.println("mItemImgs====================" + mItemImgs[j]);
