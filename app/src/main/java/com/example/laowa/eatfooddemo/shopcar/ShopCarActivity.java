package com.example.laowa.eatfooddemo.shopcar;
...
import com.example.laowa.eatfooddemo.shopcar.adapter.ShopcartAdapter;
import com.example.laowa.eatfooddemo.shopcar.entity.GoodsInfo;
import com.example.laowa.eatfooddemo.shopcar.entity.StoreInfo;
...
ShopCarActivity extends Activity implements ShopcartAdapter.CheckInterface,
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_share:
                ...
                Toast.makeText(ShopCarActivity.this, "分享成功", Toast.LENGTH_SHORT).show();
                break;
            case R.id.tv_save:
                if (totalCount == 0) {
                ...
                Toast.makeText(ShopCarActivity.this, "保存成功", Toast.LENGTH_SHORT).show();
                break;
        }
    }
